...
import { IconHandCoins, IconPenLine, IconSearch } from "./icons";
...
/** Variante A arbitrée (Task 1) — 3 cartes arrondies + icônes, un artefact par carte. */
export function Steps() {
  return (
    <section id="comment-ca-marche" className="scroll-mt-6 bg-paper-2 py-16 sm:py-20">
